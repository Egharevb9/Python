...
# #  reusable code that performs a single specific task.
# #  In python, we have the inbuilt functions, 
# # the user defined functions and lambda function(which is also a type of user defined function)
...
# score2 = int(input("Enter your score for "+ name2 + ": "))

# name3 = input("Enter third student name: ")
# score3 = int(input("Enter your score for "+ name3 + ": "))
...
# print("ln Data type checks : ")
# print("type of names:", type(name))
# print("type of scores:", type(scores))
# print("ID of name list:", id(name))
...
# upper_name = list(map(lambda n: n.upper(), name))
# print("Uppercase Names:", upper_name)

# # tep 9: Use help() to show documentation of len
# print("\nHelp on len():")
# help(len)
